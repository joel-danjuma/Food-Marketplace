const Contact = () => {
  return (
    <section>
      <div className="w-full h-[100vh] flex justify-center gradient">
        <div className="fixed lg:overscroll-none overflow-auto top-0 w-full h-full glassmorphism  flex justify-center ">
